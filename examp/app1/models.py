...
#another way to connect : from django.dispatch import receiver
...
#create profile when a new user signup
#another wway to connect: @receiver(post_save, sender=User)
def create_profile(sender, instance, created, **kwargs):
    if created:
        user_profile = Profile(user=instance)
        user_profile.save()
        #have users follow themselves
